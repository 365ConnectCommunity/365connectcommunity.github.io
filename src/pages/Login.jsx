...
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Note: Firebase usually handles auth state automatically via onAuthStateChanged in AuthContext,
                ...
                >
                    <div className="bg-gray-800 rounded-lg shadow-2xl p-8">
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full bg-white hover:bg-gray-100 text-gray-900 font-bold py-3 px-6 rounded-lg transition duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                        >
